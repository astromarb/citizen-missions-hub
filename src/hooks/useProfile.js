...
const SELECT_FIELDS = 'id, callsign, color, avatar_url, home_region, onboarding_complete, auec_balance, auec_balance_verified_at, rsi_handle, badges, banner_panel, callsign_changed_at, home_region_changed_at, rsi_handle_changed_at, auec_verification_timestamps';
